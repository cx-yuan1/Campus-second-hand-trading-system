...
import { getSystemintroDetail, updateSystemintro } from '../../api/systemintro'
import ImageUpload from '../../components/ImageUpload.vue'
import type { SystemintroItem } from '../../api/systemintro'

const loading = ref(false)
const submitLoading = ref(false)
const form = reactive<Partial<SystemintroItem>>({
  title: '',
  subtitle: '',
  content: '',
  picture1: '',
...
const loadDetail = async () => {
  loading.value = true
  try {
    const data = await getSystemintroDetail()
